#ifndef FIXED_POINT_MATH_COEFFS_H__
#define FIXED_POINT_MATH_COEFFS_H__
#pragma once
#include <vector>
#include <cstdint>
...
const std::vector<uint64_t> tan_N = {
...
const std::vector<uint64_t> trig_knots_bits = {0x1, 0x2, 0x3, 0x4, 0x5, 0x6, 0x7,
                                         0x8, 0x9, 0xa, 0xb, 0xc, 0xd, 0xe,
                                         0xf, 0x10, 0x11, 0x12, 0x13};

const std::vector<std::vector<uint64_t>> tan_coeffs = {
    // theta_1 (tan)
...
const std::vector<uint64_t> exp2_knots_bits = {
...
const std::vector<std::vector<uint64_t>> exp2_coeffs = {
    // theta_0 (2^x)
...
// input in [2^-24, 1/32)
const std::vector<uint64_t> log_knots_bits_1 = {0x1, 0x2, 0x3, 0x4, 0x5, 0x6,
                                          0x7, 0x8, 0x9, 0xa, 0xb, 0xc,
                                          0xd, 0xe, 0xf, 0x10, 0x11, 0x12};

const std::vector<std::vector<uint64_t>> log2_coeffs_1 = {
    // theta_0 (exponent = -1)
...
const std::vector<std::vector<uint64_t>> ln_coeffs_1 = {
    // theta_0 (exponent = -1)
...
// input in [1/32, 1)
const std::vector<uint64_t> log_knots_bits_2 = {
    0x8, 0x10, 0x18, 0x20, 0x24, 0x28, 0x2c, 0x30, 0x32, 0x34, 0x36, 0x38,
    0x3a, 0x3b, 0x3c, 0x3d, 0x3e, 0x3f, 0x40, 0x41, 0x42, 0x43, 0x44, 0x45,
    0x46, 0x47, 0x48, 0x49, 0x4a, 0x4b, 0x4c, 0x4d, 0x4e, 0x4f};

const std::vector<std::vector<uint64_t>> log2_coeffs_2 = {
    // theta_0 (exponent = -1)
...
const std::vector<std::vector<uint64_t>> ln_coeffs_2 = {
    // theta_0 (exponent = -1)
...
const std::vector<uint64_t> log2_int_to_float = {
...
const std::vector<uint64_t> ln_int_to_float = {
...
// input in [2^-24, 1/32)
const std::vector<uint64_t> sin_knots_bits_1 = {0x1, 0x2, 0x3, 0x4,
                                          0x5, 0x6, 0x7, 0x8};

const std::vector<std::vector<uint64_t>> sin_coeffs_1 = {
    // theta_0 (x)
...
const std::vector<std::vector<uint64_t>> cos_coeffs_1 = {
    // theta_0 (x)
...
// input in [1/32, 0.5]
const std::vector<uint64_t> sin_knots_bits_2 = {
...
const std::vector<std::vector<uint64_t>> sin_coeffs_2 = {
    // theta_0 (x)
...
const std::vector<std::vector<uint64_t>> cos_coeffs_2 = {
    // theta_0 (x)
...
const std::vector<uint64_t> exp_knots_bits_1 = {0x1, 0x2, 0x3, 0x4, 0x5, 0x6,
                                          0x7, 0x8, 0x9, 0xa, 0xb, 0xc,
                                          0xd, 0xe, 0xf, 0x10, 0x11};

const std::vector<std::vector<uint64_t>> exp_coeffs_1 = {
    // theta_0 (e^x)
...
const std::vector<uint64_t> exp_knots_bits_2 = {
...
const std::vector<std::vector<uint64_t>> exp_coeffs_2 = {
    // theta_0 (e^x)
...
// input in [2^-11, 1)
const std::vector<uint64_t> erf_knots_bits_1 = {
    0x8, 0x10, 0x14, 0x18, 0x1a, 0x1c, 0x1e, 0x20, 0x21, 0x22, 0x23, 0x24,
    0x25, 0x26, 0x27, 0x28, 0x29, 0x2a, 0x2b, 0x2c, 0x2d, 0x2e, 0x2f};

const std::vector<std::vector<uint64_t>> erf_coeffs_1 = {
    // theta_0 (1)
...
// input in [1, 3.875]
const std::vector<uint64_t> erf_knots_bits_2 = {
...
const std::vector<std::vector<uint64_t>> erf_coeffs_2 = {
    // theta_0 (1)
...
#endif // FIXED_POINT_MATH_COEFFS_H__
